defmodule Refood.Accounts.User do
  use Refood.Schema
  ...
  schema "users" do
    ...
    field :role, Ecto.Enum, values: [:admin, :manager, :shift]
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Refood.Repo)
  ...
  """
  def valid_password?(%Refood.Accounts.User{hashed_password: hashed_password}, password)
