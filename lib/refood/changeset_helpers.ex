defmodule Refood.ChangesetHelpers do
  @moduledoc """
  ...
  def sanitize_array(attrs, field, blank_value \\ "") do
    case Map.get(attrs, field, :no_value) do
      :no_value -> attrs
      nil -> attrs
      array -> Map.put(attrs, field, Enum.reject(array, &(&1 == blank_value)))
    end
  end
end
